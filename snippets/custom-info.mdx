export const CustomInfo = ({ children }) => (
  <div class='my-4 px-5 py-4 overflow-hidden rounded-xl border border-zinc-500/20 bg-zinc-50/50 dark:border-zinc-500/30 dark:bg-zinc-500/10'>
    <div class='flex items-start space-x-3'>
      <div class='mt-0.5 w-4'>
        <svg
          ...
          class='flex-none w-5 h-5 text-zinc-400 dark:text-zinc-300'
          aria-label='CustomInfo'>
