...
---
      ...
      <Accordion title="Usage with the Drivly SDK" icon="code-simple">
        ...
        import type { holidays } from '@drivly/commerce'

        const sdk = new SDK(...)

        const holidays = await sdk.holidays.update(holidaysId: string, data: holidays): Promise<holidays>
        ```
      </Accordion>
