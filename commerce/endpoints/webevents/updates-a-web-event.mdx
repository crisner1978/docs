...
---
      ...
      <Accordion title="Usage with the Drivly SDK" icon="code-simple">
        ...
        import type { webEvents } from '@drivly/commerce'

        const sdk = new SDK(...)

        const webEvents = await sdk.webEvents.update(webEventsId: string, data: webEvents): Promise<webEvents>
        ```
      </Accordion>
